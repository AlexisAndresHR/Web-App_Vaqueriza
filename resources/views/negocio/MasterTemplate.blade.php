...
<body>
	...
	<nav class="navbar navbar-light bg-light">
	  ...
	  <ul class="nav justify-content-end">
		  ...
		  <li class="nav-item">
		    <a class="badge nav-link" href="{{url('/negocio') }}"> {{ Auth::user()->nombre_tienda }} <i class="fas fa-user"></i></a> <!-- Se agrega ícono -->
		  </li>
		  <li class="nav-item">
	...
	<div class="pagina">
		...
		<!-- Código del breadcrumb eliminado... -->
		<!-- ... -->

		@include('sweetalert::alert') <!-- Para usar sweetalert2 (alerts JS responsivos) -->
		
		<!-- Sección que se sobrescribirá en las demás interfaces para Negocios -->
		@section('content')
		@show
	</div>
